...
<figure aria-label="The same folder path is decomposed under two abstractions. Regex captures positional structure (matched and captured groups, no semantic role). Templates capture named structure (literal layer, named slots, bijection visible from slot overlap). The vertical layout shows what each abstraction reveals and hides about the same input." style="margin: 2em 0;">
<div style="text-align: center; margin-bottom: 1.25em;"><div style="font-size: 1.4em; font-weight: 700; letter-spacing: 0.04em;">THE ABSTRACTION CHOICE</div><div style="font-size: 0.9em; opacity: 0.7; font-style: italic; margin-top: 0.4em;">Same input. Same matching outcome. What does each view <strong style="font-style: normal;">tell us</strong> about its structure?</div></div>
<div style="border: 1.5px solid currentColor; border-color: rgba(125,125,125,0.4); border-radius: 12px; padding: 0.9em 1.25em; margin-bottom: 0.8em;"><div style="font-size: 0.7em; font-weight: 700; opacity: 0.6; letter-spacing: 0.1em; margin-bottom: 0.4em;">INPUT — A REAL FOLDER PATH</div><code style="display: block; font-size: 1.05em; word-break: break-word; padding: 0;"><span style="opacity: 0.6;">fixtures/</span><strong style="color: #c14a3f;">10 - Projects</strong><span style="opacity: 0.6;">/</span><strong style="color: #c14a3f;">Web</strong><span style="opacity: 0.6;">/</span><strong style="color: #c14a3f;">auth</strong><span style="opacity: 0.6;">/</span><strong style="color: #c14a3f;">note.md</strong></code></div>
<div style="text-align: center; opacity: 0.55; font-style: italic; font-size: 0.8em; margin: 0.4em 0;">two views ↓</div>
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.25em;">
<div style="border: 1.5px solid #b87333; border-radius: 12px; padding: 0.9em 1.25em;"><div style="display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap; gap: 0.5em; margin-bottom: 0.6em;"><strong style="color: #b87333; letter-spacing: 0.05em; font-size: 0.95em;">REGEX VIEW — TODAY</strong><em style="opacity: 0.55; font-size: 0.78em;">syntax-only</em></div><div style="font-size: 0.7em; font-weight: 700; opacity: 0.6; letter-spacing: 0.06em; margin-bottom: 0.25em;">PATTERN</div><code style="display: block; padding: 0.5em 0.65em; background: rgba(125,125,125,0.1); border-radius: 4px; word-break: break-all; font-size: 0.85em; margin-bottom: 0.9em;">^fixtures/(\d+)\s-\s([^/]+)/([^/]+)/([^/]+)/(.+)$</code><div style="font-size: 0.78em; font-weight: 700; color: #4f8a4a; letter-spacing: 0.05em; margin: 0.6em 0 0.3em;">✓ WHAT IT GIVES US</div><ul style="margin: 0; padding-left: 1.2em; font-size: 0.92em; line-height: 1.5;"><li>match? <strong>yes</strong></li><li>5 positional capture groups: <code style="color: #b87333;">"10"</code>, <code style="color: #b87333;">"Projects"</code>, <code style="color: #b87333;">"Web"</code>, <code style="color: #b87333;">"auth"</code>, <code style="color: #b87333;">"note.md"</code></li></ul><div style="font-size: 0.78em; font-weight: 700; color: #b87333; letter-spacing: 0.05em; margin: 1em 0 0.3em;">✗ WHAT'S MISSING</div><ul style="margin: 0; padding-left: 1.2em; font-size: 0.92em; line-height: 1.5;"><li>which segment is the layer? <em style="opacity: 0.6;">unstated</em></li><li>what does each group mean? <em style="opacity: 0.6;">unnamed</em></li><li>semantic role per group? <em style="opacity: 0.6;">positional only</em></li><li>how to invert? <em style="opacity: 0.6;">hand-rolled string surgery</em></li><li>bijection check? <em style="opacity: 0.6;">asserted via metadata</em></li></ul></div>
<div style="border: 1.5px solid #4f8a4a; border-radius: 12px; padding: 0.9em 1.25em;"><div style="display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap; gap: 0.5em; margin-bottom: 0.6em;"><strong style="color: #4f8a4a; letter-spacing: 0.05em; font-size: 0.95em;">TEMPLATE VIEW — PROPOSED</strong><em style="opacity: 0.55; font-size: 0.78em;">structural</em></div><div style="font-size: 0.7em; font-weight: 700; opacity: 0.6; letter-spacing: 0.06em; margin-bottom: 0.25em;">TEMPLATE</div><code style="display: block; padding: 0.5em 0.65em; background: rgba(125,125,125,0.1); border-radius: 4px; word-break: break-all; font-size: 0.95em; margin-bottom: 0.9em;"><span style="opacity: 0.6;">fixtures/</span><strong style="color: #4f8a4a;">&#123;area&#125;</strong><span style="opacity: 0.6;">/</span><strong style="color: #4f8a4a;">&#123;slug&#125;</strong><span style="opacity: 0.6;">/</span><strong style="color: #4f8a4a;">&#123;rest&#125;</strong><span style="opacity: 0.6;">/</span><strong style="color: #4f8a4a;">&#123;file&#125;</strong></code><div style="font-size: 0.78em; font-weight: 700; color: #4f8a4a; letter-spacing: 0.05em; margin: 0.6em 0 0.3em;">✓ WHAT IT GIVES US</div><ul style="margin: 0; padding-left: 1.2em; font-size: 0.92em; line-height: 1.5;"><li>match? <strong>yes</strong></li><li><code style="color: #4f8a4a;">area</code> = <code style="color: #c14a3f;">"10 - Projects"</code></li><li><code style="color: #4f8a4a;">slug</code> = <code style="color: #c14a3f;">"Web"</code></li><li><code style="color: #4f8a4a;">rest</code> = <code style="color: #c14a3f;">"auth"</code></li><li><code style="color: #4f8a4a;">file</code> = <code style="color: #c14a3f;">"note.md"</code></li></ul><div style="font-size: 0.78em; font-weight: 700; color: #4f8a4a; letter-spacing: 0.05em; margin: 1em 0 0.3em;">✓ ALSO BUILT-IN</div><ul style="margin: 0; padding-left: 1.2em; font-size: 0.92em; line-height: 1.5;"><li>layer is the literal prefix → <strong>fixtures/</strong></li><li>slots are <strong>named</strong> → semantic role visible</li><li>inverse: instantiate template with slot values</li><li>bijection: <strong>computable</strong> from slot overlap with tag template</li><li>lossy directions: visible as one-sided slots</li></ul></div>
</div>
</figure>
...
- [Transfer operations](/obsidian-folder-tag-sync/concepts/transfer-operations/) — the 8 primitives templates layer over
